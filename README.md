...
<p align="center">🎮 Game to beat the clock by typing random words</p>
...
1. Clone the project with `git@github.com:devcass/Speed-Typer-Typing-Game.git`
2. Enter in the project with `cd Speed-Typer-Typing-Game`
